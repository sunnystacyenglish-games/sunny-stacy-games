...
export function setupViewport(host){
  ...
  const mutation=new MutationObserver(schedule);mutation.observe(host,{attributes:true,attributeFilter:['data-count']});
