...
async function refresh(){
  ...
  for(const set of sets){
    ...
    actions.append(edit,button('Play',()=>chooseGame(set),'primary'),button('Duplicate',()=>run(async()=>{await setRepository.duplicate(set.id);await refresh();message('Copy created.');})),button('Export JSON',()=>run(async()=>{
